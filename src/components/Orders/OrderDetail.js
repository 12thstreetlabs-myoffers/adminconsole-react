...
import { getOrderDetail, unmounOrders, submitEdit } from 'actions/orders';
...
function mapStateToProps(state) {
    return {
        order: state.orders.orderDetail,
    }
}
    ...
    render() {
        ...
        return (
            <div className='container-fluid order-detail-block'>
                <div className='col laundry-breadcrumb'><Link to='/dashboard/'>Home</Link> > <Link to='/orders/'>Orders</Link> > #{match.params.id}</div>
